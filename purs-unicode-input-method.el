;;; purs-unicode-input-method.el --- PureScript Unicode helper functions  -*- coding: utf-8 -*-
...
;;;###autoload
(defun turn-on-purs-unicode-input-method ()
  "Set input method `purs-unicode'.
See Info node `Unicode(purs-mode)' for more details."
  (interactive)
  (set-input-method "purs-unicode"))
...
(provide 'purs-unicode-input-method)

;;; purs-unicode-input-method.el ends here
